...
st.write('Race times - gráficos referentes a cronometragem das corridas por tempo médio (tempos de volta, setor, velocidade de reta, etc.)')
st.write('Race times - gráficos referentes a cronometragem dos treinos/qualy por menor tempo/maior velocidade')
