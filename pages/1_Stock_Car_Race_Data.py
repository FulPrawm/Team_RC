...
if option == "Tabelas":
    ...
    st.markdown(tabela1.to_html(index=False), unsafe_allow_html=True)
    ...
    st.markdown(tabela2.to_html(index=False), unsafe_allow_html=True)
    ...
    st.markdown(tabela3.to_html(index=False), unsafe_allow_html=True)
